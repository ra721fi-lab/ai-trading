...
router.post('/settings/test-telegram', authenticateToken, async (req, res) => {
  try {
    ...
    const testSignal = {
      ...
      tp3: 76200.00,
      riskReward: '1 : 2.5',
      alasan: 'Tes koneksi notifikasi bot: Terdeteksi pola Bullish Order Block dan RSI jenuh jual pada timeframe kustom.',
      potensiRisiko: 'Faktor volatilitas minor menjelang pergerakan penutupan candle harian.',
      kesimpulan: 'Setup BUY/LONG terkonfirmasi kuat untuk pengujian integrasi.',
      indicators: {
        rsi: 30.5,
        support: 73500.00,
        resistance: 75000.00
